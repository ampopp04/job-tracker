...
import static db.migration.V19__entity_expression_schema.AFTER_CREATE_FIELD_SETTER_OPERATION_NAME;
import static db.migration.V19__entity_expression_schema.ON_CREATE_FIELD_SETTER_OPERATION_NAME;

/**
 * The <class>V20__entity_number_expression_setup</class> is a migration
 * that configures expressions that generate numbers to be set on specific fields for
 * various entitiesin the system.
 *
 * @author Andrew
 */
public class V20__entity_number_expression_setup extends BaseDataMigration {
