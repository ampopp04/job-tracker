...
import static db.migration.V20__entity_expression_schema.CREATE_OBJECT_OPERATION_NAME;

/**
 * The <class>V23__entity_object_expression_setup</class> is a migration
 * that configures expressions that generate objects that are set onto new entities.
 *
 * @author Andrew
 */
public class V23__entity_object_expression_setup extends BaseDataMigration {
